...
class DCBlockListener extends BlockListener {
                    ...
                    for (int id : e.getTools()) {
                        if (id == toolId) {
                            ...
                            if (DwarfCraft.debugMessagesThreshold < 3) {
                                System.out.println("DC2: affected durability of a tool - old:"
                                        + durability);
                            }
                            ...
                            if (DwarfCraft.debugMessagesThreshold < 3) {
                                System.out.println("DC3: affected durability of a tool - new:"
                                        + tool.getDurability());
                            }
    ...
    public void onBlockDamage(BlockDamageEvent event) {
        ...
        /**
         * TODO DamageLevel functions removed.
            ...
            for (Effect e : s.getEffects()) {
                if (e.getEffectType() == EffectType.DIGTIME
                    ...
                    if (correctTool || !e.getToolRequired()) {
                        ...
                        if (DwarfCraft.debugMessagesThreshold < 3) {
                            System.out.println("DC3: Insta-mine occured. Block:"
                                    + materialId);
                        }
